...
# fill header
logentry="umee,valoper=${COS_VALOPER}"
...
then 
    ...
    then
        ...
        logentry=$logentry" ver=\"$version\",block_height=$block_height,catching_up=$catching_up,time_since_block=$time_since_block,latest_block_time=$latest_block_time,peers_num=$peers_num,voting_power=$voting_power,bl_missed=$bl_missed"
        #
